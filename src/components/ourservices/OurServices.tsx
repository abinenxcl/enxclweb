...
const OurServices = () => {
    ...
    const cards = [
        { id: 1, title: "Xclerate", imgSrc: img1, description: "We set ourselves apart in the business and management consulting industry by focusing on delivering actionable results rather than just extensive planning, while leveraging the deep expertise of our seasoned consultants.",path:'/xclerate' },
        { id: 2, title: "ITExS", imgSrc: img4, description: "Our Technology Consulting services turn your business challenges into opportunities by offering expert guidance on leveraging technology to achieve your strategic goals." ,path:'/ITExS'},
        { id: 3, title: "BizExs", imgSrc: img2, description: "Our IT Excellence services verticle is dedicated to delivering a sophisticated portfolio of IT solutions, meticulously curated to empower businesses with cutting-edge technology and expert guidance.",path:'/businessenablement' },
            ...
            <div className="bg-cover bg-fixed bg-[url('/src/assets/background.jpg')] h-auto md:px-24 py-18 p-8">
                ...
                <div className="flex justify-center gap-4 p-4 md:flex-nowrap flex-wrap w-full">
                    {cards.map(card => (
                        ...
                        >
                            <img className="absolute inset-0 w-full h-full object-cover transition-opacity duration-300 ease-in-out opacity-50" src={card.imgSrc} alt={card.title} style={{ opacity: hoveredCard === card.id ? '1' : '0.7' }} />
